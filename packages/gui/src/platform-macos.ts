...
import { macosGuiPlatformInputAdapter } from "./platform-macos-input.js";
...
export const macosGuiPlatformBackend: GuiPlatformBackend = {
	id: "macos",
	supported: true,
	unsupportedMessage: GUI_UNSUPPORTED_MESSAGE,
	toolSupport: Object.fromEntries(
		GUI_TOOL_NAMES.map((toolName) => [toolName, { supported: true }]),
	) as GuiPlatformBackend["toolSupport"],
	input: macosGuiPlatformInputAdapter,
