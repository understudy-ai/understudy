const PORT_GUIDANCE = 'Use gateway port + 3 (for gateway 23333, relay is 23336).'
...
export function classifyRelayCheckException(err, port) {
  ...
  return {
    kind: 'error',
    message: `Relay not reachable/authenticated at http://127.0.0.1:${port}/. Start Understudy browser relay and verify token.`,
  }
}
